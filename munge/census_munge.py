...
col_names = ['total_pop',
             ...
             'lfpr',
             'unemployment_rate',
             'HH_type_married_couple',
             'HH_type_cohabitating_couple',
             'HH_type_male_HHer_w_children',
             'HH_type_male_HHer_wo_children',
             'HH_type_female_HHer_w_children',
             'HH_type_female_HHer_wo_children',
             'HHs_w_children',
